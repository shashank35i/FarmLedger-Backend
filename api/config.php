...
define('DB_NAME', getenv('DB_NAME') ?: 'farmledger');
define('DB_USER', getenv('DB_USER') ?: 'farmledger');
define('DB_PASS', getenv('DB_PASS') ?: 'farmledger');
...
define('SMTP_FROM_NAME', 'FarmLedger');
define('SUPPORT_EMAIL', 'support@farmledger.example');
